...
namespace ImoSysSDK.Purchasing
{
    public class VerifyServerTask
    {
        ...
        public void Verify()
        {
            ...
            PurchaseBody body = new PurchaseBody(_purchaseToken, _productId, _productType, _nonce);
        ...
        private class PurchaseBody{
            ...
            public PurchaseBody(string purchaseToken, string productId, int productType, string nonce)
            {
